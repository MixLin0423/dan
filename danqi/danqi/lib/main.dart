...
import '4pages/我的.dart';
import '4pages/首页.dart';
import '4pages/ride.dart';
import 'test.dart';
import '4pages/装备库.dart';
import '4pages/骑行页.dart';
...
class MyHomePageState extends State<MyHomePage> {
  ...
  var pageIndex = 0;
  var pageList = [const Home(), Ride1(), zbk(), const Mine()];
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      const Padding(
                                        ...
                                        child: Text(
                                          "帖子",
                                          style: TextStyle(fontFamily: 'MiSans-Medium', fontWeight: FontWeight.w500),
                                        ),
                                      ),
                                    ],
                                  ),
...
Route _createRoute(){
  return PageRouteBuilder(
      pageBuilder: (context, animation, secondaryAnimation) =>  Ride1(),
